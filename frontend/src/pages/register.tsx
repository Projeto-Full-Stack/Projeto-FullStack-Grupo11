...
function RegisterPage() {
    return(
        ...
        <div className={`flex justify-center items-center mt-[45px] mb-[94px]`}>
                <form action="" className={`bg-grey-10 rounded flex flex-col items-start p-12 w-[412px] min-h-min `}>
                    ...
                    <div className="mt-[30px]">
                        ...
                        <span className="flex justify-between my-[10px]">
                            <label htmlFor="state" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                ...
                                <select id="state" name="estado" className="my-[5px] w-[152px] h-[40px] text-[14px] focus:outline-none focus:ring focus:ring-brand-1 text-grey-3 border-[1.5px] font-normal rounded border-grey-4 block">
