  ...
  return (
    <>
      ...
      <section className={`flex flex-col items-center p-3 gap-9 lg:py-[0px]`}>
        ...
        <article className={`flex flex-col gap-4 bg-colors_color_white_fixed rounded`}>
          <div
      ...
      <aside className={`align-middle p-11 items-center rounded flex flex-col items-start gap-[52px] bg-colors_color_white_fixed flex flex-col items-center p-3 gap-9`}>
      ...
      <section className='bg-colors_color_white_fixed px-7 py-9 flex flex-col gap-[42px]'>
        <div className='flex flex-col gap-7'>
          <Heading type="h6" weight={600}>Comentários</Heading>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <section className='flex gap-2 items-center flex-wrap'>
            <small className='text-grey-grey_3 font-medium font-[14px] px-3 bg-grey-grey7 rounded-3xl'>Gostei Muito!</small>
            <small className='text-grey-grey_3 font-medium font-[14px] px-3 bg-grey-grey7 rounded-3xl'>Incrivél</small>
            <small className='text-grey-grey_3 font-medium font-[14px] px-3 bg-grey-grey7 rounded-3xl'>Recomendaria para meus amigos!</small>
          </section>
        </div>
      </section>
      </main>
